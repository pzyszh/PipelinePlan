...
Partial Public NotInheritable Class Sheet3
    ...
    Friend WithEvents Sheet3_Print_Area As Microsoft.Office.Tools.Excel.NamedRange
    ...
    Private Sub BeginInitialization()
        Me.BeginInit
        Me.Sheet3_Print_Area.BeginInit
    End Sub
    ...
    Private Sub InitializeControls()
        Me.Sheet3_Print_Area = Globals.Factory.CreateNamedRange(Nothing, Nothing, "Sheet3!Print_Area", "Sheet3_Print_Area", Me)
    End Sub
