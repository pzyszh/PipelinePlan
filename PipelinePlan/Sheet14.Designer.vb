...
Partial Public NotInheritable Class Sheet14
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "Sheet14", "Sheet14")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Sheet14 As Sheet14
    
    Friend Shared Property Sheet14() As Sheet14
        Get
            Return _Sheet14
        End Get
        Set
            If (_Sheet14 Is Nothing) Then
                _Sheet14 = value
            Else
