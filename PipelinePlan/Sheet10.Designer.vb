...
Partial Public NotInheritable Class Sheet10
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "Sheet10", "Sheet10")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Sheet10 As Sheet10
    
    Friend Shared Property Sheet10() As Sheet10
        Get
            Return _Sheet10
        End Get
        Set
            If (_Sheet10 Is Nothing) Then
                _Sheet10 = value
            Else
