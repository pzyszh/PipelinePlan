...
Partial Public NotInheritable Class Sheet16
    Inherits Microsoft.Office.Tools.Excel.WorksheetBase
    
    Friend WithEvents Sheet16_Print_Titles As Microsoft.Office.Tools.Excel.NamedRange
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "Sheet16", "Sheet16")
    End Sub
    ...
    Private Sub BeginInitialization()
        Me.BeginInit
        Me.Sheet16_Print_Titles.BeginInit
    End Sub
    ...
    Private Sub EndInitialization()
        Me.Sheet16_Print_Titles.EndInit
        Me.EndInit
    End Sub
    ...
    Private Sub InitializeControls()
        Me.Sheet16_Print_Titles = Globals.Factory.CreateNamedRange(Nothing, Nothing, "Sheet16!Print_Titles", "Sheet16_Print_Titles", Me)
    End Sub
    ...
    Protected Overrides Sub OnShutdown()
        Me.Sheet16_Print_Titles.Dispose
        MyBase.OnShutdown
    End Sub
End Class
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Sheet16 As Sheet16
    
    Friend Shared Property Sheet16() As Sheet16
        Get
            Return _Sheet16
        End Get
        Set
            If (_Sheet16 Is Nothing) Then
                _Sheet16 = value
            Else
