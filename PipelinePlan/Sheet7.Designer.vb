...
Partial Public NotInheritable Class Sheet7
    Inherits Microsoft.Office.Tools.Excel.WorksheetBase
    
    Friend WithEvents Sheet7_Print_Area As Microsoft.Office.Tools.Excel.NamedRange
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "Sheet7", "Sheet7")
    End Sub
    ...
    Private Sub BeginInitialization()
        Me.BeginInit
        Me.Sheet7_Print_Area.BeginInit
    End Sub
    ...
    Private Sub InitializeControls()
        Me.Sheet7_Print_Area = Globals.Factory.CreateNamedRange(Nothing, Nothing, "Sheet7!Print_Area", "Sheet7_Print_Area", Me)
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Sheet7 As Sheet7
    
    Friend Shared Property Sheet7() As Sheet7
        Get
            Return _Sheet7
        End Get
        Set
            If (_Sheet7 Is Nothing) Then
                _Sheet7 = value
            Else
