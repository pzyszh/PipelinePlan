...
Partial Public NotInheritable Class Sheet12
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "Sheet12", "Sheet12")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Sheet12 As Sheet12
    
    Friend Shared Property Sheet12() As Sheet12
        Get
            Return _Sheet12
        End Get
        Set
            If (_Sheet12 Is Nothing) Then
                _Sheet12 = value
            Else
